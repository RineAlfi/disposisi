                            ...
                            <div class="card">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered table-md" style="width:100%">
                                    ...
                                    <?php
                                        ...
                                        <td >
                                            <a class="btn btn-md btn-warning" href="<?php echo base_url('data_pegawai/detail/' . $dp->nip) ?>"><i class="ti ti-info-circle"></i></a>
                                            <a class="btn btn-md btn-success" href="<?php echo base_url('data_pegawai/edit/' . $dp->nip) ?>"><i class="ti ti-pencil"></i></a>
                                            <a onclick="return confirm('Yakin hapus data ini?')" class="btn btn-md btn-danger" href="<?php echo site_url('data_pegawai/hapus/' . $dp->nip) ?>"><i class="ti ti-trash"></i></a>
                                        </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
